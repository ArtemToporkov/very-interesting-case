...
if __name__ == "__main__":
    # --- Настройки ---
    target_folder = r"/Users/aleksey/PycharmProjects/very-interesting-case"  # Текущая папка. Можно указать абсолютный или относительный путь, например "my_project_folder"
